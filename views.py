...
def friedrice(request):
    if request.user.is_authenticated:
        return render(request, "orders/friedrice.html", context = {"dishes":Pasta.objects.all})
    else:
        return redirect("orders:login")
    
def burger(request):
    if request.user.is_authenticated:
        return render(request, "orders/burger.html", context = {"dishes":Pasta.objects.all})
    else:
        return redirect("orders:login")
    
def momos(request):
    if request.user.is_authenticated:
        return render(request, "orders/momos.html", context = {"dishes":Pasta.objects.all})
    else:
        return redirect("orders:login")
